...
/**
 * Precompiled io.firefly.jacoco-convention script plugin.
 **/
public class IoFireflyJacocoConventionPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_IoFireflyJacocoConvention").asSubclass(BasicScript.class);
