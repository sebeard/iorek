...
/**
 * Precompiled io.firefly.jacoco-aggregation script plugin.
 **/
public class IoFireflyJacocoAggregationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_IoFireflyJacocoAggregation").asSubclass(BasicScript.class);
