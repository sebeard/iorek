...
@Configuration
@Import({
    CredentialSafetyConfig.class,
    PwnedPasswordsConfiguration.class
})
public class FunctionConfiguration {

    @Bean
    PasswordCheckingService passwordCheckingService(CompromisedPasswordService compromisedPasswordService, CredentialSafetyConfig credentialSafetyConfig) {
